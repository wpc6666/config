...
# soul解除送礼私聊限制     api-chat.soulapp.cn
...
# 爱剪辑-视屏剪辑&视屏编辑vlog制作 解锁会员(需要登录)     api.open.loveclip.site
...
#itranslate修复Pro    ssl-api.itranslateapp.com
...
# effie解锁订阅    api.effie.pro, api.effie.co
...
# 灵感足迹高级解锁     backend.getdrafts.com
...
# flightradar24高级解锁--Eric   mobile.flightradar24.com
...
# 大师兄影视去开屏广告     sdk.alibaba.com.ailbaba.me
...
^https:\/\/app\.yiyan\.art\/yiyan\/ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/yiyan.js
...
^https?:/\/cokemv\.me(\/?$|\/([?]|vod).*$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/cokemv.js

# > 11 PornHub[网页优化] - 网站地址：https://cn.pornhub.com
^https:\/\/(cn|www)\.pornhub\.com\/_xa\/ads url reject-dict
^https?:/\/(cn|www)\.pornhub\.com(\/?$|\/([?]|view|video).*$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/pornhub.js

# > 10 LeZhu[网页优化] - 网站地址：http://www.lezhutv.com
^https?:/\/www\.lezhutv\.com(\/?$|\/([?]|type|detail|play|index).*$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/lezhu.js

# > 09 Bimi[网页优化] - 网站地址：https://www.bimi.net
^https?:/\/www\.bimi.*\.(net\/$|net\/(vodshow|bangumi|type)\/[0-9a-z-\/]+\/$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/bimi.js

# > 08 禁漫天堂[网页优化] - 网站地址：https://18comic.org
^https?:\/\/18comic\.org(\/?$|\/([?]|album|photo).*$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/18comic.js

# > 07 555影视[网页优化] - 网站地址：https://555dy.vip
^https?:\/\/(www\.)?(5.*|o8tv)\.((cc|vip|com)\/$|(cc|vip|com)\/[a-z]+\/[0-9a-z-]+\.html) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/555.js

# > 06 剧迷[网页优化] - 网站地址：https://gimytv.app
^https?:\/\/gimytv\.(app\/$|app\/(browse\/)?[0-9a-zA-Z-_]+\.html) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/gimytv.js


# > 04 天空影视[网页优化]@ - 网站地址：https://www.tkys.tv
^https?:\/\/www\.tkys\.(tv\/$|tv\/(voddetail|vodplay)\/[0-9a-z-]+\.html$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/tkys.js

# > 03 厂长电影[网页优化]@ - 网站地址：https://www.qianoo.cn
^https?:/\/www\.qianoo\.(cn\/$|cn\/[0-9a-zA-Z_\/]+\.html$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/qianoo.js

# > 02 真不卡[网页优化]@ - 网站地址：https://www.zhenbuka5.com
^https?:\/\/www\.zhenbuka.*\.com(\/?$|\/([?]|vod).*$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/zhenbuka.js

# > 01 libvio[网页优化]@ - 网站地址：https://www.iioo.me
^https?:/\/www\.libvio\.(me\/$|me\/(detail|play)\/[0-9a-z-]+\.html$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/backup/js/libvio.js
...
^http:\/\/api\.myb6api\.(org|com):8080\/api\.php\/api\/users\/getBaseInfo url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/blsp.js
#桃子视频解锁会员     api.*.xyz
^http:\/\/api\.(.+)\.xyz\/fast-cloud\/user\/info url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/taozi.js
##酷咪视频VIP无限看    酷咪下载地址 km.app      lginstaacademy.com
^https:\/\/lginstaacademy\.com(\/\/api\/movie\/addPlay|\/\/api\/member|\/api\/video_clip\/play|\/api\/app\/message_list|\/api\/home\/index_recommend|\/\/api\/movie\/play\/|\/\/api\/vip\/index) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/kumiyw.js
...
##越南老哥langkhach270389
#vsco
^https?:\/\/vsco\.co\/api\/subscriptions\/2.1\/user-subscriptions\/ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/vsco.js
...
#Termius 
https:\/\/api\.termius\.com\/api\/v3\/bulk\/account\/ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/Terminus.js

#Vivavideo
^https:\/\/viva-asia1\.vvbrd\.com\/api\/rest\/u\/vip* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/vivavideo.vip.js

#Undfold
^https:\/\/api\.unfold\.app\/v1\/ios\/receipts$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/Unfold.vip.js

#Nhaccuatui
^https:\/\/graph\.nhaccuatui\.com\/.*\/users\/info* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/nhaccuatui.js

#Memrise
^https:\/\/api\.memrise\.com\/.+\/(me\/$|dashboard\/$|leaderboards\/following\/) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/memrise.vip.js

#sync
^https:\/\/api\.sync\.me\/api\/purchases\/(report_purchases|get_purchases)  url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/syn.me.js

#elsaresponse
^https:\/\/pool\.elsanow\.io\/user\/api\/v1\/purchase$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/elsa-response.js
...
#drops
^https:\/\/lambda\.us-east-1\.amazonaws\.com/.*/functions\/prod-4-syncPurchases\/invocations$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/drops.js

#mondly
^https:\/\/api\.mondlylanguages\.com\/v1\/ios\/user\/sync$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/mondly.vip.js

#busuu
^https:\/\/api\.busuu\.com\/users\/me* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/busuu.vip.js

#Videoshow
^https:\/\/owa\.videoshowiosglobalserver\.com\/.*\/iosPayClient url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/videoshow.vip.js

#elevate
^https:\/\/accounts\.elevateapp\.net\/api\/users\?user%5Bauthentication_token* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/elevate.vip.js

#beautyplus
^https:\/\/api-intl\.mr\.meitu\.com/.*/subs_offer_elg$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/beautyplusvip.js

#camera360
^https:\/\/bmall\.camera360\.com\/api\/(iap\/check-receipt$|mix\/getinfo$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/camera360.vip.js

#zingtv
^https?:\/\/api\.tv\.zing\.vn\/.*/user* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/zingtvvipv1.js

#calm
^https:\/\/api\.calm\.com\/me$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/calm.vip.js

#remove_manage
^https:\/\/www\.calm\.com\/mobile\/manage-subscription\?token=*  url reject-img

#lightroom
^https:\/\/photos\.adobe\.io\/v2\/accounts* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/Lightroom.js
...
^https:\/\/subs\.platforms\.team\/.+\/apple\/verify$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/productive.js

#Musixmatch
^https:\/\/apic\.musixmatch\.com\/ws\/.*\/config\.get url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/musixmatch.miao.js

#boom
^https:\/\/apimboom2\.globaldelight\.net\/itunesreceipt_v2\.php$ url 302 https://nav.qixinpro.com/rules/QuantumultX/js/yue/boom.vip.rsp

#mimo
^https:\/\/api\.getmimo\.com\/v1\/subscriptions$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/mimo.vip.js

#Bright
^https:\/\/engbright\.com\/app-portal\/apple\/receipt$ url 302 https://nav.qixinpro.com/rules/QuantumultX/js/yue/Bright.rsp

#lingokids
^https:\/\/api\.lingokids\.com\/v1\/renovate_session$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/lingokids.vip.js

#duolingo_test
^https:\/\/duolingo-leaderboards-prod\.duolingo\.com\/leaderboards* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/duolingo.js

#ulike
^https:\/\/commerce-i18n-api\.faceu\.mobi\/commerce\/v1\/subscription\/user_info$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/ulike.js

#adguardpremium
^https:\/\/mobile-api\.adguard\.com\/api\/1\.0\/ios_validate_receipt$ url 302 https://nav.qixinpro.com/rules/QuantumultX/js/yue/Adguard.rsp

#zingmp3
^https:\/\/api\.global\.mp3\.zing\.vn\/1\.0\/getUserInfo\?data=* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/zingmp3.js

#Blinkist
^https:\/\/api\.blinkist\.com\/v4\/(me$|me.json$|me\/access$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/blinkist.js

#sololearn 
^https:\/\/api\.sololearn\.com\/(Profile\/GetProfile$|authenticateDevice$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/sololearn.js

#kinemaster
^https:\/\/api-kinemaster-assetstore\.(nexstreaming|kinemasters)\.com\/.*\/product\/verifyReceipt$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/kinemaster.js

#pushover
^https:\/\/api\.pushover\.net\/1\/messages\.json* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/pushover.js

#CamScanner
^https:\/\/(api|api-cs)\.intsig\.net\/purchase\/cs\/query_property\? url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/CamScaner.js

#over
^https:\/\/api\.overhq\.com\/(user\/token\/refresh$|subscription\/verifyReceipt$) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/over.vip.js

#speak&translate
^https:\/\/receipt-validator\.herewetest\.com\/apple\/verifyTransaction$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/speak&translate.js
...
#phothop&PSexpress
^https:\/\/lcs-mobile-cops\.adobe\.io\/mobile_profile url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/photoshop.js

#itranslate&lingo&voice&converse
^https:\/\/ssl-api\.itranslateapp\.com\/.*\/subscriptions\/.*\/ios$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/itranslate.js

#pre_dayone
;^https:\/\/dayone\.me\/api\/users$ url request-header (\r\n)If-None-Match:.+(\r\n) request-header $1 

#dayone
^https:\/\/dayone\.me\/api\/(users|v2\/users\/account-status)$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/dayone.js

#endel
^https:\/\/api-production\.endel\.io\/.*\/user$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/endel.js

#shred
^https:\/\/api\.shred\.app\/verifyReceipt$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/shred.js

#nichi
^https?:\/\/mp\.bybutter\.com\/mood\/(official-templates|privileges) url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/nichi.js

#grammarly
^https:\/\/subscription\.grammarly\.com\/api\/v1$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/grammarly.js

#splice
^https:\/\/splice\.oracle\.\w+\.com\/devices\/me url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/splice.js

#planner5d
^https:\/\/planner5d\.com\/api\/sets url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/planner5d.js

#playerxtreme
;^https:\/\/secure\.istreamer\.com\/backend$ url request-header (\r\n)If-None-Match:.+(\r\n) request-header $1 

^https:\/\/secure\.istreamer\.com\/backend$ url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/playerxtreme.js

#all apps monkey
^https:\/\/www\.api\.monkeyuni\.net\/api\/.+\/mobile\/account\/load-update url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/monkey.js

#textnow
^https:\/\/api\.textnow\.me\/api2.0\/users\/.* url script-response-body https://nav.qixinpro.com/rules/QuantumultX/js/yue/Textnow.js
